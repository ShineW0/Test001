	...
	<div class="rris_container">
		...
		<!--房屋图片开始-->
			<div class="rel_room_field">
				...
				<form action="uploadHouseImgBefore.do" method="post" enctype="multipart/form-data">
					 <!--上传图片开始-->
		...
		<!--填写详细信息标题结束-->
		<form action="insertHouseBefore.do" method="post">
		<input type="text" name="u_id" value="${user.id}" style="display: none" >
			...
			<div class="ei_con">
				...
				<div class="rel_room_field">
					...
					<div class="field_frame">
						<input id="inp_css" type="text" name="house_title" />
					</div>
					<!--单选框结束-->
				</div>
				<!--房源标题结束-->
				...
				<div class="rel_room_field">
					...
					<div class="ta_room_desc" style="margin-top:20px;">
		...
		<div class="essential_infor">
			...
			<div class="ei_con">
				...
				<div class="rel_room_field">
					...
					<div class="field_frame">
						<input id="inp_css" type="text" name="village_name" />
					</div>
				</div>
				<!--小区名称结束-->
				...
				<div class="rel_room_field">
					...
					<div class="field_frame">
						<input class="house_units" type="text" name="house_room" />
						<p class="unit_p">室</p>
						<input class="house_units" type="text" name="living_room" />
						<p class="unit_p">厅</p>
						<input class="house_units" type="text" name="house_toilet" />
						<p class="unit_p">卫</p>
					</div>
				</div>
				<!--房屋户型结束-->
				...
				<div class="rel_room_field">
					...
					<div class="field_frame">
						<input class="house_units" type="text" name="house_area" />
						<p class="unit_p">平米</p>
					</div>
				</div>
				<!--房屋面积结束-->
				...
				<div class="rel_room_field">
					...
					<div class="field_frame">
						<input class="house_units" type="text" name="rental" />
