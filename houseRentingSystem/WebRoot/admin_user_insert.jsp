  ...
  <div class="settings" id="settings">
       ...
       <div id="sidebar">
        ...
        <div id="content" class="white">
    		...
    		<div class="content">
    			<form action="backstage_regist.do" method="post">
		    	<div class="input">
		    		<label class="label label_css">用户名</label>
		    		<input type="text" id="input1" placeholder="请输入用户名" name="userName" />
		    	</div>
		    	
		    	<div class="input">
		    		<label class="label label_css">密码</label>
		    		<input type="text" id="input1" placeholder="请输入密码" name="passWord" />
		    	</div>
		    	<div class="input">
		    		<label class="label label_css">年龄</label>
		    		<input type="text" id="input1" placeholder="请输入年龄" name="age" />
		    	</div>
		    	<div class="input">
		    	...
		    	<div class="input">
		    		...
		    		<input type="text" id="input1" placeholder="请输入常用邮箱" name="email"/>
		    	</div>
		    	
		    	<div class="input">
		    		<label class="label label_css">联系电话</label>
		    		<input type="text" id="input1" placeholder="请输入联系电话" name="phone"/>
		    	</div>
				<!-- 提交按钮结束 -->
