       ...
       <div id="sidebar">
            <ul>
                ...
                <li class="current"><a href="#"><img src="img/icons/menu/brush.png" alt="" />数据字典管理</a>
                    <ul>
                       	<li class="current"><a href="admin_dict_insert.jsp">添加数据字典管理</a></li>
        ...
        <div id="content" class="white">
    		...
    		<div class="content">
    		<form action="insertDict.do" method="post">
    			<!--所属父目录开始-->
		    	<div class="input">
		    		<label class="label label_css">所属父目录</label>
		    		<input type="text" id="input1"  placeholder="管理员 性别 等等" name="data_pared" list="predList"/>
		    	...
		    	<div class="input">
		    		...
		    		<input type="text" id="input1"  placeholder="管理员 性别 等等" name="data_type" list="typeList"/>
		    	...
		    	<div class="input">
		    		...
		    		<input type="text" id="input1" placeholder="请输入名称" name="data_name" />
		    	</div>
		    	<!--数据字典名称结束-->
		    	<!--数据字典编码开始-->
		    	<div class="input">
		    		<label class="label label_css">字典编码</label>
		    		<input type="text" id="input1" placeholder="请输入编码" name="data_code"/>
		    	</div>
		    	<!--数据字典编码结束-->
		        <!--提交按钮开始-->
		        <div class="submit input_css">
		            <input class="subm_in" type="submit" value="添加数据"/>
		        </div>
		        <!--提交按钮结束-->
		        </form>
		    </div>
