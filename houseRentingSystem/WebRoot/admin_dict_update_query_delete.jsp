			...
			<div class="bloc">
				...
				<table>
		            ...
		            <tbody>
		                ...
		                <tr>
		                    <td>${dict.data_name}</td>
		                    <td>${dict.data_type}</td>
		                    <td>${dict.data_pared}</td>
		                    <td>${dict.data_code}</td>
		                    <td><a href="getDictById.do?dict_id=${dict.id }" title="修改数据"><img src="img/icons/actions/edit.png" alt="" /></a></td>
		                    <td><a href="deleteDictById.do?dict_id=${dict.id}" title="删除数据"><img src="img/icons/actions/delete.png" alt="" /></a></td>
		                </tr>
		                </c:forEach>
		                </tbody>
		        </table>
			    <div class="pagination">
		            <c:if test="${pageIndex_dict>1}">
		            	<a href="getDictPage.do?pageIndex_dict=${pageIndex_dict-1}&pageNum_dict=7">«</a>
		            </c:if>
		            <a href="getDictPage.do?pageIndex_dict=${pageIndex_dict+1 }&pageNum_dict=7">»</a>
		        </div>
			    </div>
